...
namespace netmf.MC.LEDBackpack.SevenSegment
{
    /// <summary>
    /// Class to control a SevenSegment-Display driven by an Holtek HT16K33 IC
    /// 
    /// -------------------------------------------------------
    /// ATTENTION! This is just a copy of the Matrix_8x8-Class.
    /// -------------------------------------------------------
    /// 
    ...
    public class SevenSegment
    {
        ...
        public SevenSegment(byte adress)
        {
        ...
        public SevenSegment(byte adress, int clockrate)
        {
            HT16K33_ADRESS = adress;
